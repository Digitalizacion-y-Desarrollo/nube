    ...
    <main class="grid min-h-screen lg:grid-cols-2">
        <section class="login-brand-panel relative hidden min-h-screen overflow-hidden p-16 text-white lg:flex lg:flex-col lg:justify-between">
            ...
            <div class="relative z-10 max-w-[592px]">
                ...
                <h1 class="text-[44px] font-bold leading-[1.1]">Nube Empresarial</h1>
        ...
        <section class="flex min-h-screen flex-col items-center justify-between bg-white px-5 py-8 sm:px-12 lg:px-20 lg:py-12">
            ...
            <form action="{{ route('login.store') }}" method="POST" class="my-10 w-full max-w-[560px] lg:my-0" novalidate>
                ...
                <div class="mb-6">
                    ...
                    <p class="mt-1.5 text-sm leading-5 text-[#4b5563]">Accede a tu espacio seguro de archivos</p>
                </div>
                ...
                <label class="mt-6 flex w-fit cursor-pointer items-center gap-2 text-[13px] text-[#4b5563]">
                    <input
                        type="checkbox"
                        name="remember"
                        value="1"
                ...
                <a href="https://accesos.digitalneza.com" class="mt-4 block text-center text-xs font-semibold text-brand hover:underline">
                    ¿Olvidaste tu contraseña?
                </a>
            </form>

            <footer class="flex w-full max-w-[560px] flex-col items-center gap-4 text-center text-[#9ca3af]">
